 ...
 RSpec.describe Api::V1::PostsController, type: :controller do
   ...
   context "unauthenticated user" do
     ...
     it "PUT update returns http unauthenticated" do
       put :update, id: my_post.id, topic_id: my_topic.id, post: {title: "Post Title", body: "Example Post Body Example"}
       
       expect(response).to have_http_status(401)
     end
 
     it "POST create returns http unauthenticated" do
       post :create, topic_id: my_topic.id, post: {title: "Post Title", body: "Example Post Body Example"}
       expect(response).to have_http_status(401)
     end
   ...
   context "authenticated and authorized users" do
     ...
     describe "POST create" do
       before { post :create, topic_id: @new_post.topic, user_id:@new_post.user, post: {title: @new_post.title, body: @new_post.body} }
